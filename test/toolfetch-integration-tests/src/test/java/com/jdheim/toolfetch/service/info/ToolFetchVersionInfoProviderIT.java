...
/// Integration Tests Tests for [ToolFetchVersionInfoProvider]
class ToolFetchVersionInfoProviderIT {
    ...
    ToolFetchVersionInfoProvider provider;
    ...
    void testVersion() {
        ...
        String separator = ToolFetchVersionInfoProvider.separator(versionLines);
    ...
    void testVersion_Default(String versionInfoFilePath) {
        ...
        testLogListAppenderSteps.assertNoErrorNoWarn();
    }
